...
# 注册 'xhs' 命令）+ bilibili-cli（B 站 CLI，jackwener，注册 'bili' 命令，含搜索/视频
# 详情）—— 单独 layer 让上面 layer 可复用缓存
RUN pip install --no-cache-dir "yt-dlp>=2024.12.0" "xiaohongshu-cli" "bilibili-cli"
